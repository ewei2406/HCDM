...
def random_sample(adj_changes, surrogate, ori_adj, ori_features, labels, idx_train, n_perturbations):
    K = 20
    best_loss = -1000
    victim_model = surrogate
    victim_model.eval()
    with torch.no_grad():
        ...
        for i in range(K):
            ...
            modified_adj = get_modified_adj(ori_adj)
...
def projection(n_perturbations, adj_changes):
