...
for attack_method in [
  ...
  print(f'[COMPARE] Attacking {args.dataset} (selected via {args.g0_method}) with method: {args.attack_method}')
  ...
  if args.save_results: export.saveData('./compareResults.csv', results)
