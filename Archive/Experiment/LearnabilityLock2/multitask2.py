...
def eval_adj(test_adj: torch.tensor, task):
    ...
    f1_g0 = metrics.f1_score(task[g0].cpu(), pred.argmax(dim=1)[g0], average='micro')
...
for i, acc in enumerate(accs):
  print(f'task {i} | d_G0: {acc[0]} | d_GX: {acc[1]}')
...
if args.save_results: export.saveData('./multitask.csv', results)
