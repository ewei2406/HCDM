...
class Graph:
    def __init__(self, adj, labels, features, idx_train, idx_val, idx_test, split_seed, nodeid=None):
        self.adj = adj
...
def getGraph(root, name, setting, seed, device, verbose=True):
    ...
    return Graph(adj, labels, features, idx_train, idx_val, idx_test, seed)