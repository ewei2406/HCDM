...
parser.add_argument('--der1', type=float, default=0.15, help='Drop edge ratio of the 1st augmentation.')
parser.add_argument('--der2', type=float, default=0.15, help='Drop edge ratio of the 2nd augmentation.')
parser.add_argument('--dfr1', type=float, default=0.15, help='Drop feature ratio of the 1st augmentation.')
parser.add_argument('--dfr2', type=float, default=0.15, help='Drop feature ratio of the 2nd augmentation.')
